...
""" 
I don't really remember why I made a copy of the script and named it Drammensvassdraget. Maybe I changed
something, but was probably only important for the first test with Drammensvassdraget. We should work with the "get-observations_csv.py"
"""
...
def main(argv):
    ...
    Directory = os.getcwd()
    Obs_file = os.path.join(Directory, 'Data/Streamflow/OurCatchment/NVEobservations_s'+ station_id + '.cvs')
